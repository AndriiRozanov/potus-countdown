...
<repo>/
  potus-countdown/
    ...
    ... (тут лежить сайт)
За замовчуванням вивід іде в папку `potus-countdown/` (корінь сайту).

ENV:
- LANGS=uk,de,fr,es
- TIMEZONE=Europe/Kyiv
- DIGEST_MIN_ITEMS=8
- OPENAI_API_KEY=<ключ>  (щоб тексти дійсно були мовою сторінки)
...
# ========================= НАЛАШТУВАННЯ =========================
# Якщо файл лежить у potus-countdown/scripts/, то ROOT = .../potus-countdown
ROOT = pathlib.Path(__file__).resolve().parents[1]
OUT = pathlib.Path(os.getenv("OUT_DIR", ROOT))  # куди писати сторінки
